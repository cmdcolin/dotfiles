...
alias upneo="cd ~/src/neovim/; make distclean; git pull; make CMAKE_BUILD_TYPE=RelWithDebInfo CMAKE_EXTRA_FLAGS="-DCMAKE_INSTALL_PREFIX=$HOME/.local"; make install; cd -"
